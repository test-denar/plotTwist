...
const IndexPage = () => {
  ...
  const [imagesState, setImagesState] = useState([
    ...
    },
    {
      ...
      id: 2,
      text:
        "jojo <3 i’ve been trying to open and respond to this email for the last two hours but the mail app kept crashing and locking me out. i agree with you on your point about the robot hug, i don’t think a piece of technology simulated to squeeze me would ever quench that lack. i’m sure that there is tonnes research on the chemical reactions that go off in your body when you make contact with something warm, but from my astutely unscientific and naive perspective, the warmth (metaphorical + physical) of a hug is always bound to the giver of the hug, squeezing someone i love tightly. maybe i’m missing out on something big here by keeping this a social problem and denying my bodily needs, but i would prefer to hug my childhood teddy bear over a warm mechanical robot any day. today, jurgis, who shares my studio with me, was telling me about touch screen technologies, and how they use our fingers as electrical conductors to charge the interaction, so we are effectively charging our phones and tablets with our own bodies. i’m thinking back to an app i had on my first smartphone, which i used to communicate with a long distance ex. it had a blank display, but when we were both ‘in’ it, we could see where each were touching the screen with our finger tips. it felt very corny at the time, and i know i would find it even more corny now. seeing my partners’ fingers move across a screen 1) wasn’t very comforting at all and 2) brings me back to the same question: what is with this incessant drive to replicate the sensation of touch using technology? i don’t think that should be the goal. it’s not surprising that capitalism exploits our weaknesses, and longing is certainly one of them, but trying to simulate hugs and direct touch is not the way to treat loneliness or solitude. can’t we find other more exciting ways of spending time together apart that doesn’t involve trying to replicate physical interactions? on that note… i’m logging off the evening to knit my scarf and watch KUWTK",
    },
    {
      url: fourth,
      selected: false,
    ...
    },
    {
      ...
      id: 5,
      text:
        "I had a weird sensation reading that just now -- it is the first email from you that I can't read in your usual tone of voice in. What did you do/read/listen to while writing?🤔 am intentionally going to write this instantly and in one go because i want you to read it in my voice (we haven't heard each others voices all week!!!!) that really reminds me of my undergrad in anth. the suggestion of 'otherness' or trying to decipher something in terms 'other' than our own -- I don't know if that's possible for me, I know I can only think/learn in connection to things I already have some grasp/intimacy/understanding of, and I learn by getting familiar with things. was also speaking with claude (sarra's housemate) yesterday about ways we can programme ourselves to use our vagus nerves or how to get rid of intrusive thoughts. feel like I am always returning to my thesis on oliveros and 'software for people' - what tools do we have at our disposal to make things better for oursleves (everyones 'better' is different of course)-what instructions or recipes or 'meditations' can we write/formulate/code blah blah blah - also thinking back to ursula le guins idea of technology as ways for us to engage with the material world, or 'solutions'. i am always circling back to the same texts and people - same references and ideas - because that is how i am learning or trying to position things in my personal database, library, brain, network. mmm dinner is ready so i am off 🙂 love you and hope you are healthy and in a good mood and have had a nice big dinner this eve xxxx jo",
    },
    {
      url: seventh,
      selected: false,
